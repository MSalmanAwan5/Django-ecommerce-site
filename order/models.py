...
class OrderManager(models.Manager):
    def new_or_get(self, billing_profile, cart_obj):
        ...
        return order_obj, order_obj_created


class Order(models.Model):

    shipping_address =models.ForeignKey(Addresses, related_name="shipping_address", blank=True, null=True, on_delete=models.CASCADE)
    billing_address= models.ForeignKey(Addresses, related_name="billing_address", blank=True, null=True, on_delete=models.CASCADE)

    billing_profile = models.ForeignKey(BillingProfile, blank=True, null=True,on_delete=models.CASCADE)
    order_id = models.CharField(max_length=120,blank=True)
    cart = models.ForeignKey(Cart, on_delete=models.CASCADE)
    status = models.CharField(max_length=120,default='created',choices=STATUS_ORDER_CHOICES)
